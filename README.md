...
```sh
  cd my-folder
  git clone https://github.com/Tracy-miranja/sql.git
```
...
I would like to thank to all my Mricronauts partners and microverse for giving me this repository in github
...
This project is [MIT](https://github.com/Tracy-miranja/sql/blob/main/LICENSE).
